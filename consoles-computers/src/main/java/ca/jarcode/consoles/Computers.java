...
public class Computers extends JavaPlugin {
    ...
    // when everything is garbage collected _is_ inherently stupid too), since native libraries are
    ...
    // been collected and that we'll need to re-load our native component. This is not a guarantee, but
    // it works 99% of the time.

    // bukkit's /reload command should work fine with this plugin since it technically doesn't attempt
    ...
    public void onEnable() {
        ...
        loadAttempt:
        if (!LOADED_NATIVES && !ATTEMPTED_NATIVES_LOAD) {
