...
public class GeneralUtils implements GeneralInternals {
    ...
    public boolean forceAddFrame(ItemFrame frame, World bukkitWorld) {
        ...
        net.minecraft.server.v1_12_R1.World world = ((CraftWorld) bukkitWorld).getHandle();
        nms.dead = false;
    ...
    private net.minecraft.server.v1_12_R1.ItemStack nmsStack(ItemStack stack) {
        try {
            return (net.minecraft.server.v1_12_R1.ItemStack) ITEM_STACK_HANDLE.get(stack);
        } catch (IllegalAccessException e) {
            throw new RuntimeException(e);
        }
    }
